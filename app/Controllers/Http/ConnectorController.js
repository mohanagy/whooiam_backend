...
class ConnectorController {
  ...
  async initGroupChat({
    ...
    if (country != null) {
      ...
      const normalUsers = await User.query().select(['id', Database.raw("CONCAT(firstname, ' ', lastname) as name"), 'image', 'uuid', Database.raw("'normal' as user_type")]).whereIn('id', normalIds).fetch()
